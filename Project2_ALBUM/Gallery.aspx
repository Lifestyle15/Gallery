    ...
    <form id="form1" runat="server" class="main-form">
        <div class="main-div">
            ...
            <div class="top-nav">
                ...
                <br />
                <asp:Button CssClass="btn-logout" ID="btnLog" runat="server" OnClick="btnLog_Click" Text="Log Out" />    
            </div>
            ...
            <div class="main-content">
                ...
                <div class="second-nav">                                        
                    ...
                    <div class="btn-div">
                        <asp:Button CssClass="btn-upload" ID="btnUpload" runat="server" OnClick="Button1_Click" Text="Upload" />
                    </div>
                ...
                <div class="datalist-div">
                    <asp:Button CssClass="btn-search" ID="btnSearch" runat="server" OnClick="btnSearch_Click" Text="Search" />
                    ...
                    <asp:DataList CssClass="datalist" ID="DataList1" runat="server" CellPadding="4" DataKeyField="PhotoID"   Height="47px"  RepeatDirection="Horizontal" Width="100%" OnItemCommand="DataList1_ItemCommand" style="margin-top: 0px">  
               
                        <EditItemStyle CssClass="edit-item" />
